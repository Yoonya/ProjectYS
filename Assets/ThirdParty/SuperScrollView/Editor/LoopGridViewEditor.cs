    ...
    public class LoopGridViewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Application.isPlaying)
			{
                EditorGUILayout.Space();
                EditorGUILayout.Space();
                if (EditorGUILayout.Toggle("UpdateAllItem", mPlayingUpdateAllItem))
			    {                
                    mPlayingUpdateAllItem = false;
                    tListView.UpdateAllGridSetting();
                    tListView.RefreshAllShownItem();
			    }
			}
